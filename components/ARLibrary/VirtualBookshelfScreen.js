...
export default class VirtualBookshelfScreen extends React.Component {
  ...
  bookCreator = async (scene, dimensions, maxBookHeight, coverUrl, pagesUrl, xPos) => {
    ...
    console.log('this is the book xpos: ', xPos)
  ...
  shelfCreator = async (scene, dimensions, anchor) => {
    ...
    const shelf = new THREE.Mesh(geometry, material);
      console.log('this is the anchor: ', anchor)
  ...
  _onGLContextCreate = async (gl) => {
    ...
    firebase.database().ref(`items-scanned/${uid}`).on('value', bookData => {
      ...
      Object.keys(books).forEach(key => {
        ...
        this.bookCreator(scene, dimensions, maxBookHeight, coverUrl, pagesUrl, xPos)
      ...
      this.shelfCreator(scene, [shelfLength, maxBookDepth], shelfAnchor)
